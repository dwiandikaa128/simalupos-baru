...
<body class="font-sans bg-surface text-on-surface antialiased">
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 lg:ml-64 pb-16 lg:pb-0 overflow-y-auto transition-all duration-300">
            @if(session('success'))
            <div class="mx-6 mt-4 p-3 bg-green-50 border border-green-200 text-green-800 rounded-xl flex items-center gap-2 text-body-sm" id="flash-success">
            ...
            @endif
            @if(session('error'))
            <div class="mx-6 mt-4 p-3 bg-red-50 border border-red-200 text-red-800 rounded-xl flex items-center gap-2 text-body-sm" id="flash-error">
